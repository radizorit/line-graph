        ...
        return (
            <div style={{ height: '750px', width: '1500px' }}>
                <Line data={{
                    ...
                    // if (this.state.datasets.visibility)
                    //     accumulator.push(datasets)
        ...
        return this.state.datasets.map((dataset, i) => {
            return (
                <button key={i} onClick={() => {
                    //console.log(dataset.visibility, (this.state.dataset))
                    this.setState({
                        visibility: !dataset.visibility
                    })
                    console.log('This is full', this.state.datasets)
                    // console.log(dataset.visibility)
                    // console.log(dataset.visibility)
                    //console.log('Test change:', this.state.datasets[dataset.visibility])
                    // console.log('Test change:', this.state.datasets[0].visibility)
                    // console.log('Test change:', dataset.visibility)
                    // console.log('Test change:', this.state.datasets[i].visibility)
                    // console.log('Test change:', (this.state.datasets[i].visibility))
                    // console.log('Test change:', this.state.datasets[0].visibility)
                    //console.log('Test change:', this.state.datasets[i])
                }}>
